  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
          ...
          <div class="grid lg:grid-cols-2 md:grid-cols-2 lg:gap-6">
            <div class="lg:ml-12 grid grid-cols-2 ">
              <img src="img/image.png" alt="">
              <div class="lg:mt-40 mt-6 ">
                <h1 class="text lg:pb-5 pb-2 font-bold lg:text-base text-sm">Best Furniture For Your Castle....</h1>
                <h1 class="lg:pb-5 pb-2 lg:text-4xl font-bold text-black">New Furniture Collection Trends in 2020</h1>
                <h1 class="text2 text-sm lg:text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Magna in est adipiscing in phasellus non in justo.</h1>
...
<div class="lg:mt-28 mt-5 lg:px-48">
  ...
  <div class="lg:mt-12 p-10 lg:p-20 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 ">
...
<!--Leatest Products-->
<div class="lg:mt-28 mt-6 lg:px-48">
  ...
  <div class="lg:mt-12 mt-4 lg:px-20 px-8 grid lg:grid-cols-3 md:grid-cols-3 md:gap-y-10 grid-cols-2 lg:gap-y-10">
...
<div class="lg:mt-20 mt-6">
  ...
  <div class=" lg:mt-12 mt-6 px-8 lg:px-48 grid grid-cols-2 sm:grid-cols-1 gap-y-6 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 ">
...
<!--Unique features -->
<div class="lg:mt-32 mt-6 carousel">
  <div class="flex">
    <div>
      <img src="img/chairrr.png" class="lg:ml-80" alt="">
    </div>
    <div class="lg:mt-24 mt-6 pr-4 lg:pr-0">
      <h3 class="lg:text-4xl text-xl mb-2 text-center font-sans text-blue-900 font-bold">Unique Features Of leatest & Trending Poducts</h3>
      <div class="grid grid-row-3 gap-y-2 lg:ml-8 ml-2">
      ...
      <div class="flex inline-flex items-center lg:pt-7 pt-3 lg:ml-8">
        ...
        <div class="grid grid-row-2 invisible lg:visible md:visible lg:ml-4 ml-1">
...
<!-- Trendin product-->
<div class="lg:mt-32 mt-6 lg:px-48">
  ...
  <div class="lg:mt-12  p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-3 ">
    <livewire:trending-product src="img/boxforimage.png"></livewire:trending-product>
    <livewire:trending-product src="img/boxforimage.png"></livewire:trending-product>
    <livewire:trending-product src="img/boxforimage.png"></livewire:trending-product>
    <livewire:trending-product src="img/boxforimage.png"></livewire:trending-product>
...
<div class="grid lg:grid-cols-3 md:grid-cols-3 md:px-2 lg:mt-10 lg:ml-56">
  ...
  <div class="grid grid-rows-3 pt-4 p-6 md:pt-10">
...
<div class="lg:mt-32 ">
  ...
  <div class="flex lg:ml-52">
    <div class="lg:grid lg:grid-cols-2 md:flex-row md:max-w-full rounded-lg bg-white">
      <div class="p-10 flex flex-col justify-start lg:mt-28 mt-0 ">
        <h3 class="text-blue-900 font-bold lg:text-4xl text-xl font-medium mb-2">20% Discount Of All Products</h3>
        <p class="text font-bold text-base lg:mb-4 mb-2">
          Eams Sofa Compact</p>
        <p class="text-gray-400 lg:text-base text-xs">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eu eget <br>
        ...
        <div class="grid grid-cols-2">
          <div class="flex inline-flex items-center lg:mt-6"><img src="img/check.png" alt="">
            <p class="text-gray-400 text-xs lg:text-base pl-2">Material expose like metals</p>
          </div>
          <div class="flex inline-flex items-center lg:mt-6  "><img src="img/check.png" alt="">
            <p class="text-gray-400 text-xs lg:text-base pl-2">Clear lines and geomatric figures</p>
          </div>
          <div class="flex inline-flex items-center lg:mt-6"><img src="img/check.png" alt="">
            <p class="text-gray-400 text-xs lg:text-base pl-2">Simple neutral colours.</p>
          </div>
          <div class="flex inline-flex items-center lg:mt-6 "><img src="img/check.png" alt="">
            <p class="text-gray-400 text-xs lg:text-base pl-2">Material expose like metals</p>
          </div>
      ...
      <div class="flex justify-end md:px-32 lg:px-0">
...
<div class="lg:mt-32 lg:px-48">
  ...
  <div class="lg:mt-12 p-10 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-3 ">
